...
const mockCalendar = {
  ...
  weeks: [
    {
      contributionDays: [
        { contributionCount: 0, contributionLevel: 'NONE' as const, date: '2025-02-17' },
        { contributionCount: 3, contributionLevel: 'FIRST_QUARTILE' as const, date: '2025-02-18' },
        { contributionCount: 7, contributionLevel: 'SECOND_QUARTILE' as const, date: '2025-02-19' },
      ],
    },
    {
      contributionDays: [
        { contributionCount: 12, contributionLevel: 'THIRD_QUARTILE' as const, date: '2025-02-24' },
        { contributionCount: 20, contributionLevel: 'FOURTH_QUARTILE' as const, date: '2025-02-25' },
      ],
    },
  ],
};
  ...
  it('should handle single day calendar', () => {
    const singleDay = {
      ...
      weeks: [
        {
          contributionDays: [
            { contributionCount: 5, contributionLevel: 'SECOND_QUARTILE' as const, date: '2026-01-01' },
          ],
        },
      ],
    };

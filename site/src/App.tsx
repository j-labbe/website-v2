...
export default function App() {
    ...
    return (
        <div
            className={`relative transition-opacity duration-300 ${phase === "blank" ? "opacity-0" : "opacity-100"}`}
        >
            ...
            <main id="main-content">
                ...
                <div
                    className={`max-w-[1200px] mx-auto px-8 ${stagger(isVisible(5))}`}
                >
                ...
                <div
                    className={`max-w-[1200px] mx-auto px-8 ${stagger(isVisible(7))}`}
                >
